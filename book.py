...
class Book:
	...
	def scrape_book(url):
		...
		self.product_description = book_description(soup.find("article").find("p", recursive=False))
...
thebook = Book("http://books.toscrape.com/catalogue/a-light-in-the-attic_1000/index.html")
thebook.scrape_book()
thebook.print_book()
